...
let PusherService = class PusherService {
    ...
    async trigger(channel, event, data) {
        try {
            ...
            console.error(`Error al emitir el evento [${event}] en canal [${channel}]`, error);
        }
    }
};
...
exports.PusherService = PusherService = __decorate([
    ...
    __param(0, (0, common_1.Inject)(pusher_provider_1.PUSHER)),
    __metadata("design:paramtypes", [pusher_1.default])
], PusherService);
